...
H₁: Biometric measures - specifically age, fasting blood sugar (FastingBS), maximum heart rate achieved (MaxHR), and ST-segment depression (Oldpeak) — provide stronger and more reliable predictions of future heart disease risk than serum cholesterol levels alone, when controlling for other relevant health indicators.

## Data

- Source file: `data/heart.csv`
- Shape: `918 samples × 17 features`

## Summary Statistics

|       |       Age |   RestingBP |   Cholesterol |   FastingBS |    MaxHR |    Oldpeak |   HeartDisease |   Age_normalized |   Cholesterol_normalized |   MaxHR_normalized |   FastingBS_normalized |   Oldpeak_normalized |
|:------|----------:|------------:|--------------:|------------:|---------:|-----------:|---------------:|-----------------:|-------------------------:|-------------------:|-----------------------:|---------------------:|
| count | 918       |    918      |       918     |  918        | 918      | 918        |     918        |       746        |               746        |         746        |             746        |           746        |
| mean  |  53.5109  |    132.397  |       198.8   |    0.233115 | 136.809  |   0.887364 |       0.553377 |         0.507627 |                 0.30819  |           0.535094 |               0.16756  |             0.15996  |
| std   |   9.43262 |     18.5142 |       109.384 |    0.423046 |  25.4603 |   1.06657  |       0.497414 |         0.193804 |                 0.114254 |           0.184083 |               0.373726 |             0.168317 |
| min   |  28       |      0      |         0     |    0        |  60      |  -2.6      |       0        |         0        |                 0        |           0        |               0        |             0        |
| 25%   |  47       |    120      |       173.25  |    0        | 120      |   0        |       0        |         0.37     |                 0.24     |           0.4      |               0        |             0.02     |
| 50%   |  54       |    130      |       223     |    0        | 138      |   0.6      |       1        |         0.53     |                 0.29     |           0.53     |               0        |             0.1      |
| 75%   |  60       |    140      |       267     |    0        | 156      |   1.5      |       1        |         0.63     |                 0.37     |           0.68     |               0        |             0.25     |
| max   |  77       |    200      |       603     |    1        | 202      |   6.2      |       1        |         1        |                 1        |           1        |               1        |             1        |

## Exploratory Data Analysis

The following techniques were applied during EDA to uncover patterns and prepare the data:

- **Histograms** to visualize distributions of key variables
- **Box Plots** to detect outliers and assess spread
- **Scatterplots with trendlines** to explore linear relationships
- **Bubble Plot** with HeartDisease color coding to show multivariate interactions
- **Normalized Scatterplots** to compare variables on a common scale
- **Correlation Analysis** to quantify associations between predictors
- **Outlier Cleaning for Cholesterol** to improve model stability and reduce skew
...
- H₁ supported: Biometric measures (especially Oldpeak and MaxHR) outperform serum cholesterol in predicting heart disease.

## Repository Structure

```
├── data/                 # raw and processed datasets
├── figures/              # EDA & model diagnostic plots
